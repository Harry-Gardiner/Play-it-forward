...
export const makeOptions = (app) => {
    ...
    return filterUndefined(app.hooks.filter(`dev.middleware.proxy.options`, {
        ...
        logger: app.hooks.filter(`dev.middleware.proxy.options.logger`, app.isCLI() && app.context.args.log
        ...
        protocolRewrite: app.hooks.filter(`dev.middleware.proxy.options.protocolRewrite`, url.proxy.protocol.startsWith(`https`) ? `https` : undefined),
