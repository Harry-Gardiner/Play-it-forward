...
/// <reference types="node" resolution-mode="require"/>
import type { IncomingMessage, Server as HttpServer, ServerOptions as HttpServerOptions, ServerResponse } from 'node:http';
...
export interface Connection {
     ...
     * @public
     */
    onRequest(req: IncomingMessage, res: ServerResponse): Promise<ServerResponse>;
    /**
     * On error
     *
     * @remarks
