        ...
        @if ($hasAnyContent)
                    ...
                    @foreach ($publications as $pub)
                        <div class="news-media__item" data-type="publications">
                            <div class="card card--publication">
                                ...
                                <a href="{{ $pub['publication_file']['url'] }}" target="_blank"
                                    rel="noopener noreferrer">
                                    <div class="card__image">
                                        @if (!empty($pub['publication_image']))
                                            <img src="{{ $pub['publication_image']['sizes']['medium_large'] }}"
            ...
            @if ($showLoadMore)
                <div class="news-media__load-more-wrapper btn__wrapper">
                    ...
                    <button class="button button--primary button--raspberry news-media__load-more"
                        ...
                        data-has-more-news="{{ $has_more_news ?? false ? 'true' : 'false' }}" hidden>
                        Load more
                    </button>
                </div>
            @endif
